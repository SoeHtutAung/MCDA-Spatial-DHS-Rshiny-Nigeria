...
# load datasets
adm3 <- st_read("data/shp/NGA_wards_vulnerability/NGA_wards_vulnerability.shp")
# vul <- na.omit(adm3$vul)

# Define neighbours and weights
## Define which wardss are neighbours to one another based on queen contiguity
...
### scale the open defecation parameter
...
## build palette
my_palette <- c("red","yellow","green","grey")
